...
{{ include "app-deployment.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "app-deployment.selectorLabels" -}}
...
*/}}
{{- define "app-deployment.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "app-deployment.fullname" .) .Values.serviceAccount.name }}
{{- else }}
